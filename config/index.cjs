...
const USER_CONFIG = {
  ...
  TIAN_API: {
    ...
    key: '23227a3c145ffe15429f3ac8d88830fe',
  ...
  USERS: [
    {
      ...
      id: 'o0wmlvsnIztsfI5d-6hJDlJs2GQg',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      useTemplateId: 'pnmVZ9AT6n00EFDuB7GLDoeuhRtnMMulZUSzNcKVSSA',
      ...
      customizedDateList: [
        ...
        { keyword: 'meet_day', date: '2025-10-31' },
      ],
    },
    {
      // 想要发送的人的名字
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        // { keyword: 'marry_day', date: '2022-09-09' },
        { keyword: 'meet_day', date: '2025-12-13' },
      ],
    },
  ],
